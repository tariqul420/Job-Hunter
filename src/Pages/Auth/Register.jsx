        ...
        <div className="flex gap-8 my-20">
            <div className="flex flex-col w-[60%] items-end justify-center">
                ...
                <form className="space-y-4" action="">
                    ...
                    <button className="w-[435px] mx-auto border bg-color-primary py-[15px] text-white rounded-md mt-8 transition-all text-lg font-medium duration-300 hover:-translate-y-1" type="submit">Register</button>
                </form>
